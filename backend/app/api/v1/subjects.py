...
from app.schemas.subject import SubjectOut, SubjectUpdate
...
async def get_subject(
    ...
    return await service.get_by_id(subject_id, institute_id_of(current_user))
...
async def update_subject(
    ...
    service = SubjectService(db)
    return await service.update(subject_id, payload, institute_id_of(current_user))
...
async def delete_subject(
    ...
    service = SubjectService(db)
    await service.delete(subject_id, institute_id_of(current_user))
