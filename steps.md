...
1. there should option to add amonut along with mark as paid since sometimes parent doesnt pay exact installment amount they may pay more or less than installment 
2. fees related data should be visbile to owner only means distinction between owner and teacher, teacher will have all other access except accessing fees related dashboard numbers and adding updating fees on fees tab, if logged in user role is teacher then he wont see fees tab at all, however institute admin will have same access as it is
...
5. what to do with academic year eg. if year changes same student goes from class 5 to 6 , how shall we implement this