...
build same app for agro service centers who sell argo products
car parking app 


lets copy in park24 folder here with project struture and only relevant files 
both from frontend and backend